...
document.addEventListener("DOMContentLoaded", ()=>{
    console.log($725f1eb1aed1779e$exports);
    ...
    const linksData = [
        {
            source: circlesData[0],
            target: circlesData[1]
        },
        {
            source: circlesData[1],
            target: circlesData[2]
        }
    ];
    ...
    g.selectAll("circle").data(circlesData).enter().append("circle").attr("cx", (d)=>d.cx).attr("cy", (d)=>d.cy).attr("r", (d)=>d.radius).style("fill", (d)=>d.color).call($725f1eb1aed1779e$exports.drag().on("start", function(event) {
...
//# sourceMappingURL=index.65837592.js.map
